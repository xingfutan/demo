            ...
            <div class="modal-body">
              <slot name="body">
                <div class="give_body_container">
                  <div v-for='(option, index) in options' v-bind:class="{give_body: !option.onSelect, give_body_active: option.onSelect}"
                ...
                <br>
                <div>
                  接收人：<input type='text' placeholder="请输入会员卡号" v-model="member_id" @blur="user_name = member_id">
                  <span>{{user_name}}</span>
                </div>
              </slot>
            </div>
